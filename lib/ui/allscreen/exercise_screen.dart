...
class Exercise extends StatefulWidget {
  ...
  Exercise({required this.firebaseUser, required this.settings});
...
class _ExerciseState extends State<Exercise> {
  ...
  late FocusNode myFocusNode;  //added late modifier in latest version
                ...
                Padding(
                  ...
                  child: ButtonTheme(
                    ...
                    child: CustomFlatButton(
                      ...
                      borderWidth: 0,
                      color: Color(0xFFDCE2ED), fontWeight:FontWeight.bold, shape:
                       RoundedRectangleBorder(        //shape and fontWeight cant be null so     line:484 
                ...
                Padding(
                  ...
                  child: ButtonTheme(
                    ...
                    child: CustomFlatButton(
                      ...
                      borderWidth: 0,
                      color: Color(0xFF3A5998), fontWeight: FontWeight.bold, shape: RoundedRectangleBorder(        //shape and fontWeight cant be null so     line:484 
                     borderRadius: BorderRadius.circular(8.0),
                       ),
                    ),
                  ),
