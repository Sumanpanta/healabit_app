...
class ReUseTile extends StatelessWidget {
  ...
  const ReUseTile({Key? key, required this.headerText, required this.footerText, required this.iconColor}) : super(key: key);
...
class ReUseableCard extends StatelessWidget {
  ...
  const ReUseableCard({Key? key, required this.cardChild}) : super(key: key);
